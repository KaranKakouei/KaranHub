    ...
    tabItems(
      tabItem("Home",
        fluidRow(
          ...
          preparing complex scripts to perform analytical modelling of big data, and effectivelyvisualizing multi-dimensional data.", style= "text-align: justify; font-size: 18px;"),
