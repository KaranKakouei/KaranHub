      ...
      tabItems(
        tabItem("Home",
          fluidRow(
            ...
            and to filter out non predictive attributes (parameters).  You can download the data "), 
            style= "text-align: justify; font-size: 18px;"),
            #, tags$a(href="https://www.kaggle.com/loveall/appliances-energy-prediction", "here on Kaggle."
