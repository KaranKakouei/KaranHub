...
### add printed columns here
  ...
  output$code_AllAlgorithmsPy_4 <- renderText({
    ...
    "for split in splits:",
    "",
    "   # Split the data randomly into 70% train and 30% test data sets:",
...
###########################################################################################################################
  ...
  output$code_ANNsPy_3 <- renderText({
    ...
    "for split in splits:",
    "",
    "    # Split the  data into 70% training and 30% test and validation sets",
    "    X_train, X_val_and_test, Y_train, Y_val_and_test = train_test_split(X, Y, test_size=0.3)",
    "",
    "    # Split the 20% test and validation sets into 15% test and 15% validation sets",
